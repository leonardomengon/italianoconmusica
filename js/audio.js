      ...
      // NB: la riproduzione a intervalli (versi tutorial) è stata rimossa: le fasi
      // di ascolto dell'onboarding riproducono ora i file statici
      // resources/tut v1.mp3 e resources/tut v1_2.mp3 (vedi js/onboarding.js).
