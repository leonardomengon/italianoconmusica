  const API_URL = "https://script.google.com/macros/s/AKfycbykSfICz5AKMWY8S4KR2lgafDd7V82NKDGPV8mpZtGB3r_UwTfqGNvnp7ealTt6uwwJ/exec"
      ...
      const CATALOGO_URL = "https://res.cloudinary.com/gh5kjl2a/raw/upload/v1789605431/catalogo.json"
      let songs = [];
      let currentPage = 0;
      ...
      // Flag dell'onboarding (landing + funnel di primo avvio): mentre è attivo,
      // ascolti ed esercizi NON concorrono alla progressione (contano solo
      // i versi aperti e i preferiti).
